...
try:
    ...
    sys.exit("FATAL: Tuned parameter files not found. Please run all tuning scripts first.")
...
# --- THE FIX IS HERE: Removed n_jobs=-1 from SMOTE ---
...
# --- 7, 8, 9: Evaluation and Saving (Code remains the same) ---
